function Stats(x, y, w, h){
	...
	this.display = function(){
		...
		if(entities[mobIndex] && entities[mobIndex].highlighted){
			...
			text("Size: " + round(entities[mobIndex].size), this.x + 5, this.y + offset*2)
			text("Min Size: " + round(entities[mobIndex].minSize), this.x + 5, this.y + offset*3)
			text("Max Size: " + round(entities[mobIndex].maxSize), this.x + 5, this.y + offset*4)
			text("Max Speed: " + round(entities[mobIndex].maxXSpeed), this.x + 5, this.y + offset*5)
